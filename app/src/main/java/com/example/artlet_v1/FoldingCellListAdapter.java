...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            viewHolder.genre_name = cell.findViewById(R.id.title_price);
            ...
            viewHolder.content_id = cell.findViewById(R.id.content_id);
        ...
        viewHolder.fromAddress.setText(item.getContent_name());
        viewHolder.toAddress.setText(item.getType());
        viewHolder.requestsCount.setText(String.valueOf(item.getRequestsCount()));
        viewHolder.pledgePrice.setText(item.getNum_likes());
        viewHolder.artistName.setText(item.getContent_name());
